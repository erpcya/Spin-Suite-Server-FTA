...
INSERT INTO SPS_Column (AD_Reference_ID,Created,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,UpdatedBy,SPS_Column_ID,ColumnName,DefaultValue,FieldLength,IsActive,IsEncrypted,IsUpdateable,SelectionSeqNo,SeqNo,SPS_Table_ID,IsKey,IsIdentifier,IsMandatory,IsParent,IsSelectionColumn,Name,IsCentrallyMaintained,EntityType,IsAlwaysUpdateable,AD_Element_ID,IsAllowLogging,AD_Column_ID) VALUES (20,TO_TIMESTAMP('2015-04-08 11:05:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2015-04-08 11:05:00','YYYY-MM-DD HH24:MI:SS'),0,0,100,56280,'IsFarmer','N',1,'Y','f','Y',0,0,50273,'N','N','N','N','N','Is Farmer','Y','ECA01','N',56448,'Y',68540)
;
